...
<head>
    ...
    <title>Snema - Đặt vé xem phim trực tuyến</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold" href="index.blade.php">Snema</a>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="promo-card">
                            ...
                            <div class="promo-content">
                                ...
                                <a href="https://youtu.be/dQw4w9WgXcQ?si=cq4QTuHyCUQcm_OM" class="book-btn">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                </div>
