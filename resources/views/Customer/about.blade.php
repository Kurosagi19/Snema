    ...
    <div class="main-content">
        ...
        <div class="content-area">
            ...
            <section class="about-section">
                <h2>Sứ mệnh của Snema</h2>
                <div class="about-content">
                    <div class="about-text">
                        <p>Snema ra đời với sứ mệnh mang đến trải nghiệm điện ảnh hiện đại, tiện lợi và thân thiện nhất cho mọi khách hàng. Chúng tôi không ngừng đổi mới để giúp bạn đặt vé, chọn rạp, chọn ghế và nhận ưu đãi một cách dễ dàng nhất.</p>
                    </div>
                    <div class="about-image">
                        <img src="images/about.jpg" alt="Sứ mệnh Snema">
                    </div>
                </div>
            </section>
            ...
            <section class="about-section">
                ...
                <div class="team-grid">
                    <div class="team-card">
                        <img src="images/team1.jpg" alt="Nguyễn Văn A">
                        <h4>Nguyễn Văn A</h4>
                        <p>CEO & Founder</p>
                    </div>
                    <div class="team-card">
                        <img src="images/team2.jpg" alt="Trần Thị B">
                        <h4>Trần Thị B</h4>
                        <p>Trưởng phòng Kỹ thuật</p>
                    </div>
                    <div class="team-card">
                        <img src="images/team3.jpg" alt="Lê Văn C">
                        <h4>Lê Văn C</h4>
                        <p>Chuyên viên Thiết kế</p>
                    </div>
                </div>
            </section>

            <section class="about-section">
                <h2>Đối tác của Snema</h2>
                <div class="partner-logos">
                    <div class="partner-logo">CGV</div>
                    <div class="partner-logo">Lotte Cinema</div>
                    <div class="partner-logo">BHD Star</div>
                    <div class="partner-logo">Galaxy Cinema</div>
                    <div class="partner-logo">Beta Cineplex</div>
                </div>
            </section>
            ...
            <section class="contact-section">
                ...
                <div class="contact-info">
                    <p><i class="fa-solid fa-envelope"></i> Email: support@movieticket.vn</p>
                    <p><i class="fa-solid fa-phone"></i> Điện thoại: 1900 1234</p>
                    <p><i class="fa-solid fa-location-dot"></i> Địa chỉ: 123 Đường Điện Ảnh, Quận 1, TP.HCM</p>
                </div>
            </section>
        </div>
        <div class="ad-sidebar">
    ...
    <footer>
        <div class="footer-content">
            <div class="footer-section">
                <h3>Về chúng tôi</h3>
                <p>Hệ thống đặt vé phim hàng đầu Việt Nam</p>
            </div>
            <div class="footer-section">
                <h3>Liên kết</h3>
                <ul>
            ...
            <div class="footer-section">
                <h3>Liên hệ</h3>
                <p>Email: support@movieticket.vn</p>
                <p>Điện thoại: 1900 1234</p>
            </div>
        </div>
        <div class="copyright">
            <p>© 2025 - Snema - Xem phim thôi nào!</p>
        </div>
    </footer>
