    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <a href="{{ route('Movies.index') }}" class="btn btn-primary btn-lg">Xem Phim Ngay</a>
            </div>
            <div class="col-md-6">
    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <p>
                    2025 © <a href="https://bkacad.edu.vn">BKACAD</a>. All rights reserved. Developed by <a href="{{ route('Admin.dashboard') }}">Kurokuro Usagi.</a>
                </p>
            </div>
        </div>
    </div>
